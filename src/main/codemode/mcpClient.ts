...
function spawnUpstreamProcess(name: string, config: McpServerConfig, log: LogFn): ChildProcess {
...
function disposeUpstream({ name, child, log, pending, state }: DisposeUpstreamOptions): void {
  log('disposing');
  state.dead = true;
...
export async function connectUpstream(
  ...
  return createUpstreamServer(name, tools, sendRequest, () =>
