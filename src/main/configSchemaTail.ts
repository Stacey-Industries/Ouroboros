...
export const tailSchema = {
  ...
  /** Wave 17/20 — layout preset engine + chat-primary. Wave 28 — dragAndDrop, customLayouts. Wave 32 — mobilePrimary. Wave 42 — immersiveChat. */
  layout: { type: 'object', properties: { presets: { type: 'object', properties: { v2: { type: 'boolean', default: true } }, default: { v2: true } }, chatPrimary: { type: 'boolean', default: true }, dragAndDrop: { type: 'boolean', default: true }, customLayoutsPerSession: { type: 'object', additionalProperties: true, default: {} }, customLayoutsMru: { type: 'array', items: { type: 'string' }, default: [] }, globalCustomPresets: { type: 'array', items: { type: 'object' }, default: [] }, /** Wave 32 Phase A — enable mobile-primary layout when viewport < 768px. Default false (soak gate). */ mobilePrimary: { type: 'boolean', default: false }, /** Wave 42 Phase C — immersive single-column chat shell. Default false. */ immersiveChat: { type: 'boolean', default: false } }, default: { presets: { v2: true }, chatPrimary: true, dragAndDrop: true, customLayoutsPerSession: {}, customLayoutsMru: [], globalCustomPresets: [], mobilePrimary: false, immersiveChat: false } },
