...
export function gitCoChangePass(
  ...
  const commitFiles = getCommitFiles(projectRoot)
  ...
  coChangeCounts.forEach((count, key) => {
    ...
    edges.push({ project: projectName, source_id: qnA, target_id: qnB, type: 'FILE_CHANGES_WITH', props: { count } })
  })
