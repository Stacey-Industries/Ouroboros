...
function registerCreatesAssistantMessageTest(): void {
...
function registerEmptyResponseTest(): void {
...
function registerOrchestrationLinkTest(): void {
...
function registerCostFormatTest(): void {
...
describe('projectProviderResultToAssistantMessage', () => {
  registerCreatesAssistantMessageTest();
...
describe('formatToolsSummary', () => {
  test('formats tools summary with deduplication', () => {
    const tools = [{ name: 'Read' }, { name: 'Edit' }, { name: 'Read' }, { name: 'Bash' }];
