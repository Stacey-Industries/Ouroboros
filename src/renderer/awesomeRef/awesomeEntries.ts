...
import { SKILL_ENTRIES } from './awesomeEntries.skills';
...
const HOOK_ENTRIES: AwesomeEntry[] = [
  {
    ...
    installAction: {
      kind: 'hook',
      payload: { eventType: 'PostToolUse', command: 'auto-format.sh' },
    },
  },
  {
  ...
  },
  {
    ...
    installAction: {
      kind: 'hook',
      payload: { eventType: 'PostSessionStop', command: 'slack-notify.sh' },
    },
  },
  {
    id: 'hook-daily-log',
    ...
    description: 'Appends a timestamped line to ~/.ouroboros/daily.log after each session stop.',
    author: 'ouroboros-team',
    ...
    installAction: {
      kind: 'hook',
      payload: { eventType: 'PostSessionStop', command: 'daily-log.sh' },
    },
  },
];
...
const COMMAND_ENTRIES: AwesomeEntry[] = [
  {
    ...
    content:
      'You are a senior engineer. The user wants to spec out a feature.\n\n' +
  ...
  },
  {
    ...
    category: 'slash-commands',
    title: '/review',
    description: 'Reviews the current staged diff for correctness, style, and missing tests.',
    author: 'ouroboros-team',
  ...
  },
  {
    ...
    content:
      'Determine which source files changed since the last commit:\n' +
  ...
  },
  {
    ...
    content:
      'The user wants to migrate/rename a module. Ask:\n' +
...
const RULE_ENTRIES: AwesomeEntry[] = [
  ...
  },
  {
    ...
    installAction: {
      kind: 'rule',
      payload: { scope: 'global', name: 'conventional-commits', content: '' },
    },
  },
  {
    ...
    installAction: {
      kind: 'rule',
      payload: { scope: 'global', name: 'no-compat-shims', content: '' },
    },
  },
];
