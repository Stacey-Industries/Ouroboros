    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          animation: isVisible
            ? 'ext-overlay-in 180ms ease forwards'
            : 'ext-overlay-out 180ms ease forwards',
        }}
      >
        <div
          ...
          style={{
            ...
            animation: isVisible
              ? 'ext-card-in 200ms ease forwards'
              : 'ext-card-out 200ms ease forwards',
          }}
        >
          {/* Header */}
          <div
