...
function YamlDashRow({
  ...
  return (
    <>
      <line x1="3" y1={y} x2="5" y2={y} stroke={color} strokeWidth="1.4" strokeLinecap="round" />
      <line
        x1="6.5"
        y1={y}
        x2={x2Text}
...
export function YamlIcon({ color }: { color: string }): React.ReactElement {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" style={S}>
      <YamlDashRow y={4.5} color={color} x2Text={13} />
      <YamlDashRow y={8} color={color} x2Text={11} />
      <YamlDashRow y={11.5} color={color} x2Text={13} />
    </svg>
  );
}
...
export { CfgIcon, FolderOpenSvg, ImgIcon, LockIcon, ShIcon } from './fileTypeIcons-extra';
