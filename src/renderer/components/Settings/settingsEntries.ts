...
const PERFORMANCE_ENTRIES = createEntries('performance', 'Performance', [
  [
    'Startup Timings',
    'View per-phase app startup times: app-ready, window-ready, ipc-ready, services-ready, renderer-bundle-loaded, react-root-created, first-render.',
  ],
  [
    'Runtime Metrics',
    'Live heap used/total, external memory, and CPU usage. Updated every 5 seconds.',
  ],
