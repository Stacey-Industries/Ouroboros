...
import { DEFAULT_SPINNER_CHARS, SPINNER_PRESETS } from '../../themes/thinkingDefaults';
...
function PresetSelect({
  ...
  return (
    <select
      ...
      value={value}
      onChange={onChange}
      aria-label="Spinner preset"
      data-testid="spinner-preset-select"
    >
...
function CustomInput({
  ...
  return (
    <input
      ...
      value={value}
      onChange={onChange}
      placeholder="Enter spinner chars"
      aria-label="Custom spinner characters"
...
export function SpinnerPresetPicker({
  chars,
  onChange,
}: SpinnerPresetPickerProps): React.ReactElement {
  ...
  return (
    <div style={rowStyle}>
      ...
      {presetId === CUSTOM_ID && <CustomInput value={customChars} onChange={handleCustomChange} />}
