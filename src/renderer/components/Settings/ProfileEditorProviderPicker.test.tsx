...
describe('ProfileEditorProviderPicker', () => {
  ...
  it('renders all three provider options', () => {
    render(<ProfileEditorProviderPicker value="claude" onChange={vi.fn()} />);
  ...
  it('marks the current value as checked', () => {
    render(<ProfileEditorProviderPicker value="codex" onChange={vi.fn()} />);
  ...
  it('defaults to claude when value is undefined', () => {
    render(<ProfileEditorProviderPicker value={undefined} onChange={vi.fn()} />);
    const radios = screen.getAllByRole('radio') as HTMLInputElement[];
  ...
  it('calls onChange with the selected provider id', async () => {
    ...
    render(<ProfileEditorProviderPicker value="claude" onChange={onChange} />);
    const radios = screen.getAllByRole('radio') as HTMLInputElement[];
    const codexRadio = radios.find((r) => r.value === 'codex')!;
