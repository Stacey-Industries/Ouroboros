...
export function NoProjectState({ onClose }: { onClose: () => void }): React.ReactElement {
  return (
    <PanelFrame
      onClose={onClose}
      title="Orchestration"
      subtitle="Open a project folder to inspect orchestration state."
    >
      <div
        className="flex flex-1 items-center justify-center p-6 text-[13px]"
  ...
  return (
    ...
    >
      <div className="min-w-0">
        ...
        <div
          className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-[12px]"
          style={{ color: 'var(--text-muted)' }}
        >
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <ActionButton
        ...
        onClick={props.onRerunVerification}
        disabled={!props.canRerunVerification}
      />
  ...
  return (
    <button
      ...
      style={{
        ...
        cursor: 'pointer',
        lineHeight: 1,
      }} // touch-target-ok — orchestration panel is accessed via centre pane menu, not a primary mobile-active surface
    >
      x
    </button>
  );
