...
function DailyBarTooltip({ cost }: { cost: number }): React.ReactElement {
  return (
    <div
...
function SessionTokenStats({ session }: { session: SessionUsage }): React.ReactElement {
  return (
...
function SessionDateRange({ session }: { session: SessionUsage }): React.ReactElement {
  return (
...
function SessionRowContent({ session }: { session: SessionUsage }): React.ReactElement {
...
function HistorySessionRow({
  ...
  isExpanded,
  onToggle,
}: HistorySessionRowProps): React.ReactElement {
  return (
    <div>
      <button
...
export function HistorySessionList({ sessions }: { sessions: SessionUsage[] }): React.ReactElement {
