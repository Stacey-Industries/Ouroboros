...
export const UsageRangeControls = memo(function UsageRangeControls({
  ...
  onRangeChange,
  onRefresh,
}: UsageRangeControlsProps): React.JSX.Element {
  return (
...
const RangeButton = memo(function RangeButton({
  ...
  onClick,
  option,
}: RangeButtonProps): React.JSX.Element {
  return (
    <button
...
export const UsageModalContent = memo(function UsageModalContent({
  ...
  onRetry,
  summary,
}: UsageModalContentProps): React.JSX.Element {
  return (
...
function SummaryCard({ card }: { card: SummaryCardData }): React.JSX.Element {
  return (
