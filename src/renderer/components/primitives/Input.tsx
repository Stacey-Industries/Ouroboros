...
const BASE =
  'bg-surface-base border border-border-semantic text-text-semantic-primary placeholder:text-text-semantic-muted rounded-md focus:border-interactive-accent focus:outline-hidden w-full transition-colors duration-100';
