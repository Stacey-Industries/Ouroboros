  ...
  return (
    ...
    >
      <div className="flex flex-wrap gap-x-4 gap-y-0.5 text-text-semantic-muted">
        <span>
          Model: <span className="text-text-semantic-primary">{entry.model}</span>
        </span>
        <span>
          Input:{' '}
          <span className="text-text-semantic-primary">{formatTokenCount(entry.inputTokens)}</span>
        </span>
        <span>
          Output:{' '}
          <span className="text-text-semantic-primary">{formatTokenCount(entry.outputTokens)}</span>
        </span>
        ...
        <span>
          Session: <span className="text-text-semantic-primary">{entry.sessionId.slice(0, 8)}</span>
        </span>
        <span>
          Time:{' '}
          <span className="text-text-semantic-primary">
