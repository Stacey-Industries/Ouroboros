...
function ReplayHeaderTitle({ taskLabel }: { taskLabel: string }): React.JSX.Element {
  return (
...
function ReplayTransportBar({ replay }: { replay: SessionReplayController }): React.JSX.Element {
  return (
