...
const MARKDOWN_PREVIEW_STYLES = `
  .md-preview { font-family: var(--font-ui); color: var(--text-primary); line-height: 1.7; }
  ...
  .md-preview h1 { font-size: 1.75em; border-bottom: 1px solid var(--border-subtle); padding-bottom: 0.25em; }
  .md-preview h2 { font-size: 1.4em; border-bottom: 1px solid var(--border-subtle); padding-bottom: 0.2em; }
