...
export const editorThemeExtensions: Extension[] = [
  EditorView.theme({
    ...
    '.cm-panels': { backgroundColor: 'var(--bg-secondary, var(--bg))', color: 'var(--text)' },
    ...
    '.cm-tooltip': { backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border)', color: 'var(--text)' },
