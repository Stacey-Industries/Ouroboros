    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div style={{ padding: '0 8px 6px', flexShrink: 0 }}>
        <FilterInputs
          ...
          expanded={local.filterExpanded}
          onToggle={() => local.setFilterExpanded((v) => !v)}
        />
      </div>
      <SearchStatus
        query={state.query}
        resultCount={state.results.length}
        fileCount={state.groupedResults.size}
