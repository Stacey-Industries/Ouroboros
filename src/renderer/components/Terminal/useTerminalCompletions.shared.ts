...
async function generateGitBranchCompletions(word: string, cwd_: string): Promise<Completion[]> {
...
async function generateFileCompletions(word: string, cwd_: string): Promise<Completion[]> {
...
function resolveSearchDir(dirPart: string, cwd_: string, sep: string): string {
