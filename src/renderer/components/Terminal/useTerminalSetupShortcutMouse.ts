...
import { classifySelection, INITIAL_SELECTION_TOOLTIP } from './SelectionTooltip';
...
function toggleTerminalFlag(setter: Dispatch<SetStateAction<boolean>>): false {
...
function handleCopyOrSigint(context: TerminalSetupLifecycleContext, term: Terminal): boolean {
...
function handlePasteShortcut(context: TerminalSetupLifecycleContext, event: KeyboardEvent): void {
...
function clearStoredTimer(timerRef: TerminalSetupRuntimeRefs['clickResetTimerRef']): void {
