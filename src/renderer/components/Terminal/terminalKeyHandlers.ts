...
export function attachOnKeyHandler(term: Terminal, deps: KeyHandlerDeps) {
  return term.onKey((e) => {
...
export function attachCustomKeyHandler(term: Terminal, deps: KeyHandlerDeps): void {
...
function handleCompletionNav(domEvent: KeyboardEvent, key: string, d: KeyHandlerDeps): boolean {
  const cs = d.completionState;
...
function trackPrintable(key: string, d: KeyHandlerDeps): void {
  ...
  d.suggestionControls.searchHistorySuggestionsRef.current?.(d.historyRefs.currentLineRef.current);
}

function processCustomKey(e: KeyboardEvent, term: Terminal, d: KeyHandlerDeps): boolean {
...
function handleRichInputShortcut(
  e: KeyboardEvent,
  _term: Terminal,
  d: KeyHandlerDeps,
): boolean | undefined {
...
function handleCommandSearchShortcut(
  e: KeyboardEvent,
  _term: Terminal,
  d: KeyHandlerDeps,
): boolean | undefined {
