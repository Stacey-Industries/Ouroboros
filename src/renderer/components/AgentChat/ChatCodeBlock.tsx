...
export const ChatCodeBlock = React.memo(function ChatCodeBlock({
  ...
  const { status, errorMessage, diffLines, apply, accept, reject, revert, canRevert } =
    useApplyCode(code, language ?? '', filePath);
