...
export function ContextSummaryRow({ message }: { message: AgentChatMessageRecord }): React.ReactElement<any> | null {
...
export function VerificationSummaryRow({ message }: { message: AgentChatMessageRecord }): React.ReactElement<any> | null {
...
export function ErrorInline({ message }: { message: AgentChatMessageRecord }): React.ReactElement<any> | null {
  return message.error ? <div className="mt-1 text-[11px] text-status-error">{message.error.message}</div> : null;
}

export function ToolsSummaryRow({ message }: { message: AgentChatMessageRecord }): React.ReactElement<any> | null {
  return message.toolsSummary ? <div className="mt-1 text-[11px] text-text-semantic-muted">{message.toolsSummary}</div> : null;
}

export function CostDurationRow({ message }: { message: AgentChatMessageRecord }): React.ReactElement<any> | null {
...
export function MessageActionLink({ message, onOpenLinkedDetails }: { message: AgentChatMessageRecord; onOpenLinkedDetails: (link?: AgentChatOrchestrationLink) => Promise<void>; }): React.ReactElement<any> | null {
...
function UserMessageEditMode(props: Pick<UserMessageProps, 'editDraft' | 'onEditDraftChange' | 'onEditSubmit' | 'onCancelEdit'>): React.ReactElement<any> {
...
export const UserMessage = React.memo(function UserMessage(props: UserMessageProps): React.ReactElement<any> {
...
export function AssistantBlocksContent({ blocks, isStreaming = false, onStop }: { blocks: AgentChatContentBlock[]; isStreaming?: boolean; onStop?: () => Promise<void>; }): React.ReactElement<any> {
...
export const AssistantMessage = React.memo(function AssistantMessage(props: { message: AgentChatMessageRecord; workspaceRoot?: string; onOpenLinkedDetails: (link?: AgentChatOrchestrationLink) => Promise<void>; onBranch: (message: AgentChatMessageRecord) => void; onRevert?: (message: AgentChatMessageRecord) => void; }): React.ReactElement<any> {
...
export function StatusMessage(props: { message: AgentChatMessageRecord }): React.ReactElement<any> {
...
export function MessageCard(props: MessageCardProps): React.ReactElement<any> {
...
function CancelledPartialBanner(): React.ReactElement<any> {
...
export function FailedBanner({ activeThread }: { activeThread: AgentChatThreadRecord }): React.ReactElement<any> | null {
...
export function MissingProjectState(): React.ReactElement<any> {
...
export function EmptyConversationState({ onSelectPrompt }: { onSelectPrompt?: (prompt: string) => void }): React.ReactElement<any> {
...
export function QueuedMessageBanner(props: { messages: import('./useAgentChatWorkspace').QueuedMessage[]; onEdit: (id: string) => void; onDelete: (id: string) => void; onSendNow: (id: string) => Promise<void>; }): React.ReactElement<any> | null {
...
export function PendingUserBubble({ text }: { text: string }): React.ReactElement<any> {
...
export function InlineError({ error }: { error: string | null }): React.ReactElement<any> | null {
