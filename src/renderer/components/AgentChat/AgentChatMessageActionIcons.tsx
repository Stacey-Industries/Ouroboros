/**
 * AgentChatMessageActionIcons — SVG icon components for message action bars.
 * Extracted to keep AgentChatMessageActions.tsx under the 300-line ESLint cap.
 */
...
export function RewindIcon(): React.ReactElement {
  return (
    <svg
      width="14"
      height="14"
