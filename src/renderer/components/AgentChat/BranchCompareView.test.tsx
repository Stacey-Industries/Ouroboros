...
function setupElectronApi(
  handler: (
    threadId: string,
  ) => Promise<{ success: boolean; thread?: AgentChatThreadRecord; error?: string }>,
): void {
...
describe('BranchCompareView', () => {
  it('shows loading state initially', () => {
    ...
    render(<BranchCompareView leftThreadId="l" rightThreadId="r" onClose={vi.fn()} />);
  ...
  it('renders both thread labels after load', async () => {
    ...
    render(<BranchCompareView leftThreadId="left" rightThreadId="right" onClose={vi.fn()} />);
  ...
  it('calls onClose when the close button is clicked', async () => {
    const onClose = vi.fn();
    render(<BranchCompareView leftThreadId="l" rightThreadId="r" onClose={onClose} />);
