...
describe('PinnedContextCard', () => {
  it('renders the item title', () => {
    render(<PinnedContextCard item={makeItem()} onDismiss={vi.fn()} onRemove={vi.fn()} />);
  ...
  it('calls onDismiss with item id when Dismiss button is clicked', () => {
    ...
    render(<PinnedContextCard item={makeItem()} onDismiss={onDismiss} onRemove={vi.fn()} />);
  ...
  it('calls onRemove with item id when Remove button is clicked', () => {
    ...
    render(<PinnedContextCard item={makeItem()} onDismiss={vi.fn()} onRemove={onRemove} />);
  ...
  it.each<[PinnedContextType, string]>([
    ...
    render(<PinnedContextCard item={makeItem({ type })} onDismiss={vi.fn()} onRemove={vi.fn()} />);
