...
function PanelGridIcon(): React.JSX.Element {
  return (
    <svg
      width="14"
      height="14"
...
function HeaderCloseButton({ onClick }: { onClick: () => void }): React.JSX.Element {
  return (
    <button
      onClick={onClick}
...
function TokenMetric({ stats }: { stats: BatchStats }): React.JSX.Element {
  return (
    <div className="flex items-center gap-1">
...
export function MonitorFooter({ stats }: { stats: BatchStats }): React.JSX.Element {
  return (
