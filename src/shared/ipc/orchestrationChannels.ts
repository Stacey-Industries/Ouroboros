/**
 * shared/ipc/orchestrationChannels.ts
 *
 * Orchestration IPC channel constants — self-contained, no imports from main.
 * Shared across main/renderer/preload without process-boundary violations.
 *
 * src/main/orchestration/events.ts re-exports from here so existing main-process
