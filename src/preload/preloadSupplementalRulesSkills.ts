...
export const rulesAndSkillsApi: RulesAndSkillsApi = {
  listRules: (projectRoot: string) => ipcRenderer.invoke('rules:list', projectRoot),
  ...
  listCommands: (projectRoot?: string) => ipcRenderer.invoke('commands:list', projectRoot),
  ...
  listRuleFiles: (projectRoot?: string) => ipcRenderer.invoke('rulesDir:list', projectRoot),
  ...
  onChanged: (callback: () => void) => onChannel<void>('rulesAndSkills:changed', callback),
};
