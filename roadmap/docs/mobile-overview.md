...
## `roadmap/docs/mobile-dev.md` — Development setup and daily workflow
...
## `roadmap/docs/mobile-access.md` — User-facing pairing, capability gate, and security (Wave 33a)
...
## `roadmap/docs/mobile-not-a-wrapper-checklist.md` — Phase G acceptance gate
...
## `roadmap/docs/mobile-testing.md` — Automated suites and manual Android smoke (Wave 33b Phase I)
...
## `roadmap/docs/mobile-release.md` — Android release build pipeline (Wave 33b Phase H)
...
## `roadmap/docs/mobile-dispatch.md` — Cross-Device Session Dispatch user guide (Wave 34 Phase H)
