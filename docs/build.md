...
- **File watcher exclusions**: `electron.vite.config.ts` ignores `docs/`, `roadmap/`, `ai/`, `stats/`, `*.md`, etc. to prevent agent/IDE file changes from triggering hot-reload restarts.
