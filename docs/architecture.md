...
- **Chat workbench** (`config.layout.chatWorkbench === true`): chat-first workstation layout with `WorkbenchRail`, central `AgentChatWorkspace`, `ChatWorkbenchArtifactPane`, `ChatWorkbenchUtilityDrawer`, and `ChatWorkbenchTerminalDock`.
